...
<body>
    <div class="container mt-4">
        ...
        <form action="process_add_attention_importance.php" method="POST">
            <div class="mb-3">
                <label for="attentionAdder" class="form-label">ค่าความสนใจ</label>
                <input type="number" class="form-control" id="attentionAdder" name="attentionAdder" required>
            </div>
