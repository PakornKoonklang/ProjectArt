...
<body>
    ...
    if (isset($_GET['attention_Id'])) {
        ...
        $sql = "SELECT * FROM branches_attention WHERE attention_Id = $attentionId";
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <form action="process_edit_attention.php" method="post">
                    ...
                    <div class="mb-3">
                        <label for="attentionAdder" class="form-label">ชื่อความสนใจ</label>
                        <input type="text" class="form-control" id="attentionAdder" name="attentionAdder" value="<?php echo $row['attention_Adder']; ?>" required>
                    </div>
