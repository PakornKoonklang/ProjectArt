    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <form action="../Edit/process_edit_importance_branches_subjectvc.php" method="post">
                    ...
                    <div class="mb-3">
                        <label for="subjectVC_name" class="form-label">ชื่อวิชา VC</label>
                        <input type="text" class="form-control" id="subjectVC_name" name="subjectVC_name" value="<?php echo htmlspecialchars($row['subjectVC_name']); ?>" readonly>
                    </div>
                    ...
                    <a href="../Manage/manage_importance_subjectvc.php" class="btn btn-secondary">ยกเลิก</a>
                </form>
            </div>
        </div>
    </div>
