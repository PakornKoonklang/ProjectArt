        ...
        <div class="col-9">
            ...
            <body>
                <div class="col-md-9" id="contentContainer">
                    <h2 class="text-primary" id="welcomeMessage">จัดการรายชื่อด้านความสนใจ</h2>
                    <button type="button" class="btn btn-success mb-3"
                        onclick="window.location.href='add_attention.php';">เพิ่มรายชื่อด้านความสนใจ</button>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href='edit_attention.php?attention_Id=<?php echo $row['attention_Id']; ?>'
                                            class='btn btn-warning mx-1'>Edit</a>
                                        <a href='process_delete_attention.php?attention_Id=<?php echo $row['attention_Id']; ?>'
