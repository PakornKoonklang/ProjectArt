            ...
            <body>
                <div class="col-md-9" id="contentContainer">
                    ...
                    <button type="button" class="btn btn-success mb-3"
                        onclick="window.location.href='add_branches.php';">เพิ่มรายชื่อสาขา</button>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href='edit_branches.php?branches_Id=<?php echo $row['branches_Id']; ?>'
                                            class='btn btn-warning mx-1'>Edit</a>
                                        <a href='process_delete_branches.php?branches_Id=<?php echo $row['branches_Id']; ?>'
...
function loadPage(page) {
    window.location.href = "manage_branches.php?page=" + page;
}
</script>
