...
<body>
    ...
    $sql_grade = "SELECT * FROM subjects WHERE study_level_Id = 2";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        while ($branch = $result_branches->fetch_assoc()) {
            ...
            foreach ($grade_memberships as $subjectId => $membership_value) {
                $sql_subject_multiplier = "SELECT subject_Multiplier FROM branches_subjects WHERE branches_Id = $branch_id AND subject_Id = $subjectId AND study_level_Id = 2";
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <h3>รายวิชาพื้นฐานระดับประกาศนียบัตรวิชาชีพ(ปวช.) </h3>
                <form method="post">
                    <table class="table">
                        <thead>
                            <tr>
            ...
            <div class="col">
                <h3>ด้านความสนใจระดับประกาศนียบัตรวิชาชีพ(ปวช.)</h3>
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col">ชื่อรายวิชา</th>
        ...
        <a href="../form2/formgradeVc.php" class="btn btn-primary"><i>รีเซ็ต</i></a>
        </form>
    </div>
    <div class="container">
        <div class="row">
