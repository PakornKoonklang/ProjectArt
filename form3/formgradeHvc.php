...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        while ($branch = $result_branches->fetch_assoc()) {
            ...
            foreach ($grade_memberships as $subjectId => $membership_value) {
                $sql_subject_multiplier = "SELECT subject_Multiplier FROM branches_subjects WHERE branches_Id = $branch_id AND subject_Id = $subjectId AND study_level_Id = 1";
    ...
    <div class="container">
        ...
        <a href="../form3/formgradeHvc.php" class="btn btn-primary"><i>รีเซ็ต</i></a>
        </form>
    </div>
    <div class="container">
        <div class="row">
